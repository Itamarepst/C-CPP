...
typedef std::map<sp_movie, std::vector<double>> recommendation_ranks;

class RecommendationSystem
{

  /*maps from pointer of a movie ,to a vector of content rank order */
  std::map<sp_movie, std::vector<double>>  _movie_ranks;

  /*maps from Movie type to a pointer of a that movie*/
  std::map<Movie,sp_movie> movie_top_p;
