...
{
    // A pointer to the nodes data
    void *markov_data;


    // A pointer to its frequency list
...
struct MarkovNodeFrequency
{
    ...
    // The amount of times the Node data (*MarkovNode -> data) appears in list
    int frequency;
};
